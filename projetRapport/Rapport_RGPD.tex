...
\begin{titlepage}
    ...
    {\color{green!60!black}\rule{0.8\textwidth}{3pt}}
    
    \vfill
    
    % Membres du groupe et Professeur sur la même ligne
    \begin{minipage}[t]{0.5\textwidth}
    \raggedright
    {\large \textbf{Membres du Groupe :}}\\[0.5cm]
    KABORE Wend-Benindo François\\[0.2cm]
    SISSAO Sarata\\[0.2cm]
    YÉ ELISÉ NIKIESSAN\\
    \end{minipage}
    \hfill
